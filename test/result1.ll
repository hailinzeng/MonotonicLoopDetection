...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [7 x i32], [7 x i32]* %a, i64 0, i64 %idxprom, !monotonic.unsafe.index !1
...
for.body61:                                       ; preds = %for.cond59
  ...
  %arrayidx65 = getelementptr inbounds [7 x i32], [7 x i32]* %d, i64 0, i64 %idxprom64, !monotonic.unsafe.index !1
...
for.body71:                                       ; preds = %for.cond69
  ...
  %arrayidx74 = getelementptr inbounds [7 x i32], [7 x i32]* %e, i64 0, i64 %idxprom73, !monotonic.unsafe.index !1
...
for.cond78:                                       ; preds = %for.inc82, %for.end77
  ...
  %arrayidx81 = getelementptr inbounds [7 x i32], [7 x i32]* %f, i64 0, i64 %idxprom80
