...
for.body:                                         ; preds = %for.cond
  ...
  %2 = call i1 @__check_array_max(i32 %i.0, i32 3)
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = call i1 @__check_array_min(i32 %g.0, i32 1)
  %2 = call i1 @__check_array_max(i32 %g.0, i32 3)
  %arrayidx = getelementptr inbounds [7 x i32], [7 x i32]* %arr, i64 0, i64 %idxprom
...
for.body:                                         ; preds = %for.cond
  %idxprom = sext i32 %i.0 to i64
  %1 = call i1 @__check_array_min(i32 %i.0, i32 1)
  %2 = call i1 @__check_array_max(i32 %i.0, i32 %argc)
  %arrayidx = getelementptr inbounds [7 x i32], [7 x i32]* %arr, i64 0, i64 %idxprom
...
for.body:                                         ; preds = %for.cond
  %add = add nsw i32 %i.0, 1
  %idxprom = sext i32 %i.0 to i64
  %1 = call i1 @__check_array_min(i32 %i.0, i32 %argc)
  %2 = call i1 @__check_array_max(i32 %i.0, i32 10)
  %arrayidx = getelementptr inbounds [7 x i32], [7 x i32]* %arr, i64 0, i64 %idxprom
  store i32 %add, i32* %arrayidx, align 4
  br label %for.inc
...
for.body:                                         ; preds = %for.cond
  ...
  %idxprom = sext i32 %i.0 to i64
  %1 = call i1 @__check_array_min(i32 %i.0, i32 0)
  %2 = call i1 @__check_array_max(i32 %i.0, i32 %j.0)
  %arrayidx = getelementptr inbounds [7 x i32], [7 x i32]* %arr, i64 0, i64 %idxprom
  store i32 %add, i32* %arrayidx, align 4
  br label %for.inc
...
for.body:                                         ; preds = %for.cond
  %add = add nsw i32 %i.0, 1
  %idxprom = sext i32 %i.0 to i64
  %1 = call i1 @__check_array_min(i32 %i.0, i32 %j.0)
  %2 = call i1 @__check_array_max(i32 %i.0, i32 10)
  %arrayidx = getelementptr inbounds [7 x i32], [7 x i32]* %arr, i64 0, i64 %idxprom
  store i32 %add, i32* %arrayidx, align 4
  br label %for.inc
